...
def advanced_radiomics_visualization(train_data):
    ...
    st.text(cr)
    st.header("11. Class Distribution Across Features")
    st.markdown("""
        This section provides a detailed view of the distribution of each feature across different classes.
        Box plots are used to visualize the spread and central tendency of the feature values for each class.
    """)
